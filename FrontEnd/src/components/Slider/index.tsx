            ...
            <div className="col-10">
                <div id="carousel" className="carousel slide carousel-dark" data-bs-ride="carousel">
                    ...
                    <div className="carousel-inner rounded-3">
                        <div className="carousel-item active"> {/*../../../public/Storm-300-1.jpg*/}
                            <img className="d-blok w-100" src="Storm-300-1.jpg" alt="Compressor1" />
                            <div className="carousel-caption d-none d-md-block">
                                <h5 className="display-5">Compressor 1</h5>
                                <p>Imagem Exemplo</p>
                            </div>
                        </div>
                        <div className="carousel-item ">  {/*// ../../../public/Storm-300-1.jpg*/}
                        <img className="d-blok w-100" src="Storm-300-1.jpg" alt="Compressor2" />
                            <div className="carousel-caption d-none d-md-block">
                        ...
                        <div className="carousel-item ">  {/*// ../../../public/Storm-300-1.jpg*/}
                        <img className="d-blok w-100" src="Storm-300-1.jpg" alt="Compressor3" />
                            <div className="carousel-caption d-none d-md-block">
